    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Admin Busur</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse" >
				...
				<li class="text-center">
                    <img src="../img/busurico.png" class="user-image img-responsive"/>
					</li>
                    <li><a class="active-menu"  href="index.php "><i class="fa fa-dashboard fa-3x"></i> Home</a></li>
                    <li><a class="active-menu"  href="index.php?halaman=produk"><i class="fa fa-book fa-3x"></i> Produk</a></li>
                    <li><a class="active-menu"  href="index.php?halaman=pembelian"><i class="fa fa-bookmark fa-3x"></i> Pembelian</a></li>
                    <li><a class="active-menu"  href="index.php?halaman=pelanggan"><i class="fa fa-group fa-3x"></i> Pelanggan</a></li>
